...
// Created by ZENA(TM) Version 2.99.12.0, 9/12/2008, 14:02:40
...
//--------------------------------------
    {
        ...
        10,
        { 
            MANAGE_NO_DATA_ATTRIBUTE_CLUSTER,
            RETRIEVE_PACKET_COUNT_CLUSTER,
            PACKET_COUNT_RESPONSE_CLUSTER,
            MANAGE_8BIT_INTEGER_ATTRIBUTES_CLUSTER,
            BUFFER_TEST_RESPONSE_CLUSTER,
            MANAGE_16BIT_INTEGER_ATTRIBUTES_CLUSTER,
            MANAGE_SEMI_PRECISION_ATTRIBUTES_CLUSTER,
            MANAGE_TIME_ATTRIBUTES_CLUSTER,
            REVERSE_FREEFORM_MSG_RESPONSE_CLUSTER,
            MANAGE_STRING_ATTRIBUTES_CLUSTER
        }, 
        10,
        { 
            MANAGE_NO_DATA_ATTRIBUTE_CLUSTER,
